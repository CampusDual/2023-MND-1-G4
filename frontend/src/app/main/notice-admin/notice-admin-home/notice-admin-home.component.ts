...
@Component({
  selector: 'app-notice-admin-home',
  templateUrl: './notice-admin-home.component.html',
  styleUrls: ['./notice-admin-home.component.css']
})
export class NoticeAdminHomeComponent implements OnInit {
